...
$user = new Users();
$user->findById($_SESSION['id_user']);
    ...
    <div class="hero-unit">
        ...
        if (!$taskList['tache']) {
            ...
            foreach ($taskList['tache'] as $tasks) {
                ...
                echo '<td><button class="btn btn-large btn-default fini" data-tid="'.$tasks['id_tache'].'">Fini !</button></td>';
                echo "</tr>";
            }
            echo '</table>';
        }
        ?>
        <div>
            <a id="refresh" data-id="<?php echo $_SESSION['id_user'] ?>" class="icon-refresh"></a>
        </div>
    </div>
